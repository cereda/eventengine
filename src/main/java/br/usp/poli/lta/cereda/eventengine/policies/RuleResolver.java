...
/**
 * Interface da resolução de regras.
 *
...
public interface RuleResolver {
    ...
    /**
     * Escolhe, na coleção de regras válidas, qual regra será aplicada no
     * contexto corrente.
     *
     * @param matches Coleção de regras válidas.
     * @return Regra a ser aplicada.
     */
